...
public class HighwayIssue extends Issue {
    ...
    public HighwayIssue(String title, String description, Priority priority, Status status, String location) {
        super(title, description, priority, status, location);
    }

    public HighwayIssue(String title, String description, Priority priority, Status status, String location, double latitude, double longitude) {
